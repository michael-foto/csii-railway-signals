...
namespace RailwaySignals
{
    ...
    public class Setting : ModSetting
    {
        ...
        [SettingsUISlider(min = 0, max = 300, step = 10, unit = Unit.kLength)]
        [SettingsUISection(kSection, kBlockGroup)]
        public int minBlockLength { get; set; }
        ...
        /// <summary>Fewest tracks under a structure that get a gantry instead of lineside posts. Zero disables them.</summary>
        ...
        /// <summary>Closest two signals on one gantry, and two separately counted tracks, may sit across the track, in metres.</summary>
        ...
        /// <summary>Offsets how far off its track centre a gantry-carried signal sits, in metres.</summary>
        [SettingsUISlider(min = -3f, max = 3f, step = 0.05f, unit = Unit.kLength, scalarMultiplier = 1f)]
        [SettingsUISection(kSection, kAdvancedGroup)]
        [SettingsUIAdvanced]
        public float adjustGantryLateral { get; set; }

        /// <summary>Offsets the height of a gantry-carried head above rail level, in metres.</summary>
        [SettingsUISlider(min = -3f, max = 3f, step = 0.05f, unit = Unit.kLength, scalarMultiplier = 1f)]
        [SettingsUISection(kSection, kAdvancedGroup)]
        [SettingsUIAdvanced]
        public float adjustGantryHeadHeight { get; set; }

        /// <summary>Offsets a gantry-carried head from its cage across the track, in metres.</summary>
        [SettingsUISlider(min = -2f, max = 2f, step = 0.05f, unit = Unit.kLength, scalarMultiplier = 1f)]
        [SettingsUISection(kSection, kAdvancedGroup)]
        [SettingsUIAdvanced]
        public float adjustGantryHeadSide { get; set; }

        /// <summary>Offsets a gantry-carried head from its cage along the track, in metres.</summary>
        [SettingsUISlider(min = -2f, max = 2f, step = 0.05f, unit = Unit.kLength, scalarMultiplier = 1f)]
        [SettingsUISection(kSection, kAdvancedGroup)]
        [SettingsUIAdvanced]
        ...
        public override void SetDefaults()
        {
            ...
            holdTrainsAtSignals = true;
            holdReleaseSeconds = 20;
            intermediateBlockSpacing = 500;
            intermediateOnBidirectionalTrack = true;
            minBlockLength = 50;
            mediumSpeedCurveRadius = 50;
            mediumSpeedLimit = 10;
